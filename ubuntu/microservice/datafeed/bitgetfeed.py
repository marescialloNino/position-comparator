    ...
    def _init_API(self):
        try:
            if self.account == '0':
                ...
                self.__PASS__ = os.environ['BITGET_API_PASSWORD']
            elif self.account == '2RO':
                self.__API_KEY = os.environ['BITGET_PAIRSPREAD2_API_KEY_RO']
                self.__API_SEC = os.environ['BITGET_PAIRSPREAD2_API_SECRET_RO']
                self.__PASS__ = os.environ['BITGET_API_PASSWORD_2']
